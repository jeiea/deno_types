declare module 'stream' {
  import type * as events from 'https://cdn.jsdelivr.net/npm/@types/node@14.14.16/events.d.ts';
  import 'https://cdn.jsdelivr.net/npm/@types/node@14.14.16/globals.d.ts';
