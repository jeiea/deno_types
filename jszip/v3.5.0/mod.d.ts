// Adapted for deno from https://github.com/Stuk/jszip/blob/master/index.d.ts
import type { Buffer } from 'https://cdn.jsdelivr.net/npm/@types/node@14.14.16/buffer.d.ts';
import type { NodeJS } from '../../node/v14/stream.d.ts';
