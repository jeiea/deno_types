 ...
 * @see [React Hooks](https://reactjs.org/docs/hooks-intro.html)
 */
export type StatelessComponent<P = {}> = FunctionComponent<P>;
...
// but can be given its own specific name
export type MemoExoticComponent<T extends ComponentType<any>> = NamedExoticComponent<
...
export type LazyExoticComponent<T extends ComponentType<any>> = ExoticComponent<
  ComponentPropsWithRef<T>
> & {
  readonly _result: T;
};
...
export type EventHandler<E extends SyntheticEvent<any, any>> = {
...
export type Requireable<T> = PropTypes.Requireable<T>;

export type ValidationMap<T> = PropTypes.ValidationMap<T>;
